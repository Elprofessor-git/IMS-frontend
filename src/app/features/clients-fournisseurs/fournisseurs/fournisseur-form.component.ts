...
@Component({
  ...
  template: `
    <mat-card>
      <mat-card-header>
        <mat-card-title>{{ isEdit ? 'Modifier' : 'Ajouter' }} un Fournisseur</mat-card-title>
      </mat-card-header>
      <mat-card-content>
        <form [formGroup]="fournisseurForm" (ngSubmit)="onSubmit()">
          <mat-form-field appearance="outline" class="full-width">
            ...
            <mat-error *ngIf="fournisseurForm.get('nom')?.hasError('required')">
              Le nom est requis
            </mat-error>
          </mat-form-field>
          ...
          <mat-form-field appearance="outline" class="full-width">
            ...
            <mat-error *ngIf="fournisseurForm.get('email')?.hasError('required')">
              L'email est requis
            </mat-error>
            <mat-error *ngIf="fournisseurForm.get('email')?.hasError('email')">
          ...
          <div class="form-actions">
            <button mat-raised-button color="primary" type="submit" [disabled]="!fournisseurForm.valid">
